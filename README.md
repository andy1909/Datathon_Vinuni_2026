...
*Bước 2: Khởi chạy dự báo: 
  **Mở file pipeline_model.ipynb bằng Jupyter Notebook hoặc VS Code. Chạy tuần tự các ô code (Run All) từ trên xuống dưới để xem chi tiết quá trình tiền xử lý, Cross-validation và biểu đồ SHAP.
